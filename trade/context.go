...
// TradeContext is a client for interacting with Longport Trade OpenAPI.
// Longport Trade OpenAPI document is https://open.longportapp.com/en/docs/trade/trade-overview
//
// Example:
//
