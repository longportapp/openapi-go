...
// Client is a http client to access Longport REST OpenAPI
type Client struct {
	opts       *Options
...
// New create http client to call Longport REST OpenAPI
...
// NewFromCfg init Longport http client from *config.Config
