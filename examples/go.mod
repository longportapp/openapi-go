...
require github.com/longbridgeapp/openapi-go v0.0.0-00010101000000-000000000000
...
require (
	...
	github.com/longbridgeapp/openapi-protocol/go v0.0.0-20220617065631-e58f4fac810b // indirect
